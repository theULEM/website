    ...
    return (
      <div className="container">
        ...
        >
          ...
          <input type="hidden" name="debugEmail" value="pascalguerre@hotmail.com" /> */}
          <InputGroup
            label="First Name"
            id="first_name"
            name="first_name"
          ...
          <div className="form-group">
            ...
            <div className="select-red rounded">
              ...
              >
                ...
                <option value="DigiUL Graphic Design Lab">
                  DigiUL Graphic Design Lab
                </option>
                <option value="Health Care Institute">
