        ...
        <div className="row">
          ...
          <div className="col-lg-7">
            ...
            <section className="mb-5">
              ...
              <p>
                One hundred years ago, local business and civic leaders of
                diverse backgrounds and ethnicity created what was known as the
                Boston Urban League. In 1919, the League brought together
                individuals that were doing similar work to share in one large
                appeal to help individuals move from dependency to
                self-sufficiency. While our role in the community has not
                changed throughout the years, we continue to bring together the
                resources to thousands of individuals and families seeking to
                live out the American Dream of life, liberty and the pursuit of
                happiness. This historic centennial offers an unparalleled
                opportunity to commemorate a milestone of the civil rights
            ...
            <section className="mb-5">
              ...
              <div className="mb-4">
                ...
                <div>
                  <ul>
                    ...
                    <li>
                      Mark Walker, Vice Chair, Sr. Vice President, Credit
                ...
                <table>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        Vice President, BMC Healthnet Plan/Well Sense Health
                      </td>
                    </tr>
                    <tr>
                      <td>Steve Duncan</td>
                    ...
                    <tr>
                      <td>Liz Walker</td>
                      <td>
                        President, Urban League of Eastern Massachusetts, YPN
                      </td>
                    </tr>
                    <tr>
              ...
              <div className="mb-4">
                ...
                <ul>
                  <li>
                    Joyce London Ford, ret. Chief U.S. Magistrate Judge-District
                    of Massachusetts
                  </li>
                  <li>
                    Samuel J. Gerson, former President, Filenes Basement,
                    (deceased)
                  </li>
                  <li>
                    Quincy Miller, President and Vice Chairman, Eastern Bank
                  </li>
                  <li>Jeff Musman, Esq., Managing Partner, Seyfarth Shaw</li>
                  <li>
                    George A. Russell, Jr., ret. Senior Vice President, State
                    Street Corporation
                  </li>
              ...
              <div className="mb-4">
                ...
                <ul>
                  ...
                  <li>
                    Dawn-Frazier-Bohnert, Senior Vice President and Chief
                    Diversity Officer, Liberty Mutual
                  </li>
                  ...
                  <li>
                    Mary Jo Meisner, Senior Executive and Community Leader
                  </li>
                  <li>
                    Dr. Larry Dunham, Director, Diversity & Multicultural
                ...
                <table>
                  <tbody>
                    ...
                    <tr>
                      <td>Tonya Kibbe </td>
                      <td>
                        Assistant Coordinator, OVW Domestic/Sexual Violence
                        Program
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                        Program Coordinator, Mature Workers Skills Program
                      </td>
                    </tr>
                    <tr>
                      <td>Othneil Uter</td>
                    ...
                    <tr>
                      <td>Shiyu Wang</td>
                      <td>
                        Workforce Development Program Coordinator/Instructor
                      </td>
                    </tr>
                  </tbody>
                </table>
