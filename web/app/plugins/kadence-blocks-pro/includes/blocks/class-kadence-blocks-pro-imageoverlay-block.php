...
class Kadence_Blocks_Pro_Imageoverlay_Block extends Kadence_Blocks_Pro_Abstract_Block {
	...
	public function build_css( $attributes, $css, $unique_id, $unique_style_id ) {
		...
		$css->set_selector( '.kt-img-overlay' . $unique_id . ' .kt-image-overlay-message .image-overlay-title' );
		...
		$css->add_property( 'padding', ( ! empty( $attributes['titlePadding'] ) && isset( $attributes['titlePadding'][0] ) ? $attributes['titlePadding'][0] . 'px ' . $attributes['titlePadding'][1] . 'px ' . $attributes['titlePadding'][2] . 'px ' . $attributes['titlePadding'][3] . 'px' : '' ) );
		$css->add_property( 'margin', ( ! empty( $attributes['titleMargin'] ) && isset( $attributes['titleMargin'][0] ) ? $attributes['titleMargin'][0] . 'px ' . $attributes['titleMargin'][1] . 'px ' . $attributes['titleMargin'][2] . 'px ' . $attributes['titleMargin'][3] . 'px' : '' ) );
		...
		if ( isset( $attributes['dividerStyle'] ) && $attributes['dividerStyle'] ) {
			$css->set_selector( '.kt-img-overlay' . $unique_id . ' .kt-image-overlay-divider' );

			$divider_border_color = ( ! $attributes['dividerColor'] ? $css->render_color( '#fff', $attributes['dividerOpacity'] ) : $css->render_color( $attributes['dividerColor'], $attributes['dividerOpacity'] ) );

			$css->add_property( 'border-top-color', $divider_border_color );
			$css->add_property( 'border-top-width', $attributes['dividerHeight'] ? $attributes['dividerHeight'] . 'px' : '1px' );
			$css->add_property( 'width', $attributes['dividerWidth'] ? $attributes['dividerWidth'] . '%' : '80%' );
			$css->add_property( 'border-top-style', $attributes['dividerStyle'] );
		}

		$css->set_selector( '.kt-img-overlay' . $unique_id . ' .kt-image-overlay-message .image-overlay-subtitle' );
		...
		$css->add_property( 'padding', ( ! empty( $attributes['subtitlePadding'] ) && isset( $attributes['subtitlePadding'][0] ) ? $attributes['subtitlePadding'][0] . 'px ' . $attributes['subtitlePadding'][1] . 'px ' . $attributes['subtitlePadding'][2] . 'px ' . $attributes['subtitlePadding'][3] . 'px' : '' ) );
		$css->add_property( 'margin', ( ! empty( $attributes['subtitleMargin'] ) && isset( $attributes['subtitleMargin'][0] ) ? $attributes['subtitleMargin'][0] . 'px ' . $attributes['subtitleMargin'][1] . 'px ' . $attributes['subtitleMargin'][2] . 'px ' . $attributes['subtitleMargin'][3] . 'px' : '' ) );
